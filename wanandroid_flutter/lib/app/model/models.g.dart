...
_$TreeBeanImpl _$$TreeBeanImplFromJson(Map<String, dynamic> json) =>
    _$TreeBeanImpl(
      articleList: json['articleList'] as List<dynamic>?,
      author: json['author'] as String?,
      children: (json['children'] as List<dynamic>?)
          ?.map((e) => TreeChildrenBean.fromJson(e as Map<String, dynamic>))
          .toList(),
      courseId: json['courseId'] as int?,
      cover: json['cover'] as String?,
      desc: json['desc'] as String?,
...
Map<String, dynamic> _$$TreeBeanImplToJson(_$TreeBeanImpl instance) =>
    <String, dynamic>{
      'articleList': instance.articleList,
      'author': instance.author,
      'children': instance.children,
...
_$TreeChildrenBeanImpl _$$TreeChildrenBeanImplFromJson(
        Map<String, dynamic> json) =>
...
Map<String, dynamic> _$$TreeChildrenBeanImplToJson(
        _$TreeChildrenBeanImpl instance) =>
    <String, dynamic>{
      'articleList': instance.articleList,
      'author': instance.author,
      'children': instance.children,
